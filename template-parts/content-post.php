<article class="project <?php if(get_field('project_reverse')) echo 'project--reverse'; ?>">
  <header class="project__header">
    <h1 class="heading--md reveal"><?php the_title(); ?></h1>
    <h2 class="medium--upper reveal">MARM THINKS - <?php echo get_the_date('d.m.y') ?></h2>
    <button class="project__scroll reveal">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.31 56.15"><title>arrow down</title><polygon points="34.31 39 17.16 56.15 0 39 1.41 37.58 16.16 52.32 16.16 0 18.16 0 18.16 52.32 32.9 37.58 34.31 39" /></svg>
    </button>
  </header>
